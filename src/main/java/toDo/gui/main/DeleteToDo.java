...
public class DeleteToDo extends JFrame implements ActionListener
{
	...
	public DeleteToDo(List<ToDoHolder> newList, MainGui m)
	{
		super("Delete To Do Items");
	...
	public void actionPerformed(ActionEvent e) 
	{
		if (e.getSource() == bDelete)
		{
			...
			if (index != -1)
			{
				ToDoHolder selectedHolder = (ToDoHolder)list.get(index);
				...
				if (optionPicked == JOptionPane.YES_OPTION)
				{
					 ...
					 * mainGui when mainGui refreshes it creates a new list so 
